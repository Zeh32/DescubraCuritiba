...
public class FirstScreen extends AppCompatActivity {
    ...
    private void addPlaces( ) {
        ...
        places.add( new Place( 44, "Shopping Jardim das Américas", "shopping jardim da americas.jpg", -25.4513486, -49.2284538, false, 1, 90, new ArrayList<>( Arrays.asList( PlaceGroup.FOOD, PlaceGroup.SHOPPING ) ), "Localizado no bairro Jardim das Américas, o Shopping tem desenvolvido uma forte relação com a comunidade local, seja por meio dos laços de compras ou primando pelo desenvolvimento social. O resultado disso pode ser observado na fidelização dos clientes e na confiança que as pessoas têm no empreendimento." ) );
