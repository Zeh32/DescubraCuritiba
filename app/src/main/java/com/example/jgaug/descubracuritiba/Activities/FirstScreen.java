...
public class FirstScreen extends AppCompatActivity {
    ...
    private void addPlaces( ) {
        ...
        places.add( new Place( 0, "Jardim Botânico", "jardim botanico.jpg", "-25.4431219,-49.2449701", true, 5, 120, new ArrayList<>( Arrays.asList( PlaceGroup.PARKS, PlaceGroup.LANDMARKS ) ), "O Jardim Botânico de Curitiba foi inaugurado em 1991, com uma área de 245 mil m². Seus jardins geométricos e a estufa de três abóbadas tornaram-se um dos principais cartões postais de Curitiba." ) );
        ...
        places.add( new Place( 2, "Parque Tanguá", "parque tangua.jpg", "-25.3779871,-49.2839598", true, 5, 120, new ArrayList<>( Arrays.asList( PlaceGroup.PARKS, PlaceGroup.LANDMARKS ) ), "Inaugurado em 1996, o Parque Tanguá surpreende pela sua beleza. Envolve uma área de 235 mil m², lugar de um antigo complexo de pedreiras desativadas. O Parque Tanguá preserva áreas verdes próximas à nascente do Rio Barigui, com araucárias. Possui uma cascata, dois lagos e um túnel artificial que pode ser visitado de barco ou à pé. O conjunto do parque inclui, também, um mirante, ciclovia, pista de Cooper e lanchonete." ) );
        ...
        places.add( new Place( 11, "Passeio Público", "passeio publico.jpg", "-25.4253578,-49.2674283", true, 4, 90, new ArrayList<>( Arrays.asList( PlaceGroup.PARKS, PlaceGroup.LANDMARKS ) ), "O Passeio Público é o parque mais central e o primeiro de Curitiba. Inaugurado em 1886 com cerca de 70 mil m² de mata natural, nas margens do rio Belém. Na época sua iluminação era feita por lampiões alimentados por azeite de peixe." ) );

        places.add( new Place( 12, "Praça Osório", "praca osorio.jpg", "-25.4329247,-49.2758622", true, 3, 60, new ArrayList<>( Arrays.asList( PlaceGroup.PARKS, PlaceGroup.LANDMARKS ) ), "Nasceu em 1874 e recebeu, em 1878, o nome de Largo Oceano Pacífico. É Praça General Osório desde 1879. Teve coreto em 1914, construído pelo prefeito Cândido Ferreira de Abreu e demolido no início dos anos 50. Seu relógio, restaurado em 1993, relembra o primeiro lá instalado, e marca a hora oficial da cidade. Tem fonte luminosa e equipamentos de lazer para a garotada." ) );
        places.add( new Place( 13, "Praça Santos Andrade", "praca santos andrade.jpg", "-25.428763,-49.2665674", true, 2, 30, new ArrayList<>( Arrays.asList( PlaceGroup.PARKS, PlaceGroup.LANDMARKS ) ), "Uma praça cercada de tradição cultural, no Centro de Curitiba. De um lado, a Universidade Federal do Paraná, do outro o Teatro Guaíra, um dos mais importantes do Brasil. A Praça Santos Andrade abriga árvores antigas, vários bustos de personalidades históricas e uma fonte no centro." ) );
